  function rollgeno(){
    ...
    function rollcoat() { 
      ...
      function basecoat() {
        ...
        //yellow
        var csyellow = ssplit.search(/\b(Yd|ya|ys|yg|yb|yc)(Yd|ya|ys|yg|yb|yc)\b/);
        var cdyellow = dsplit.search(/\b(Yd|ya|ys|yg|yb|yc)(Yd|ya|ys|yg|yb|yc)\b/);

        function rollyellow() {      
          var s1 = ssplit.match(/\b(Yd|ya|ys|yg|yb|yc)(?=Yd|ya|ys|yg|yb|yc)/);
          var s2 = ssplit.match(/(?<=Yd|ya|ys|yg|yb|yc)(Yd|ya|ys|yg|yb|yc)\b/);
          var d1 = dsplit.match(/\b(Yd|ya|ys|yg|yb|yc)(?=Yd|ya|ys|yg|yb|yc)/);
          var d2 = dsplit.match(/(?<=Yd|ya|ys|yg|yb|yc)(Yd|ya|ys|yg|yb|yc)\b/);
        ...
        //dune
        var csdune = ssplit.search(/\b(Dnc|dna|dnt|dnd|dnl|dns)(Dnc|dna|dnt|dnd|dnl|dns)\b/);
        var cddune = dsplit.search(/\b(Dnc|dna|dnt|dnd|dnl|dns)(Dnc|dna|dnt|dnd|dnl|dns)\b/);

        function rolldune() {      
          var s1 = ssplit.match(/\b(Dnc|dna|dnt|dnd|dnl|dns)(?=Dnc|dna|dnt|dnd|dnl|dns)/);
          var s2 = ssplit.match(/(?<=Dnc|dna|dnt|dnd|dnl|dns)(Dnc|dna|dnt|dnd|dnl|dns)\b/);
          var d1 = dsplit.match(/\b(Dnc|dna|dnt|dnd|dnl|dns)(?=Dnc|dna|dnt|dnd|dnl|dns)/);
          var d2 = dsplit.match(/(?<=Dnc|dna|dnt|dnd|dnl|dns)(Dnc|dna|dnt|dnd|dnl|dns)\b/);
      ...
      function phenobasecoat() {
        function normalbase() {
          if (temppuppy.search(/\b(ZZ|Zz)\b/) != -1) {
            if (temppuppy.search(/\b(YdYd|Ydya|Ydys|Ydyg|Ydyb|Ydyc)\b/) != -1) {
              pheno.push("Dark Yellow");
            } else if (temppuppy.search(/\b(yaya|yays|yayg|yayb|yayc)\b/) != -1) {
              pheno.push("Ash Yellow");
            } else if (temppuppy.search(/\b(ysys|ysyg|ysyb|ysyc)\b/) != -1) {
            ...
            if (temppuppy.search(/\b(DncDnc|Dncdna|Dncdnt|Dncdnd|Dncdnl|Dncdns)\b/) != -1) {
              pheno.push("Chestnut Dune");
            } 
            else if (temppuppy.search(/\b(dnadna|dnadnt|dnadnd|dnadnl|dnadns)\b/) != -1) {
              pheno.push("Dark Dune");
            }
            else if (temppuppy.search(/\b(dntdnt|dntdnd|dntdnl|dntdns)\b/) != -1) {
